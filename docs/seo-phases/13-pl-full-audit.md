# Faz 13 — Lehçe (/pl) tam denetimi

**Durum:** DONE
**Ölçüm:** production, 2026-09-07 — örnekleme yok, /pl altındaki bütün envanter.
...
- `/pl` — hreflang-incomplete
- `/pl/admin` — should-be-noindex, duplicate-title, duplicate-description
- `/pl/admin/login` — should-be-noindex, duplicate-title, duplicate-description
- `/pl/blog/antalya-alanya-czas-przejazdu` — hreflang-redirect-target, hreflang-not-reciprocal
- `/pl/blog/antalya-transfer-24-7` — og-image-broken
- `/pl/blog/ceny-transferu-lotnisko-antalya` — og-image-broken
- `/pl/blog/mercedes-vito-transfer-vip-antalya` — og-image-broken
- `/pl/blog/transfer-lotnisko-antalya-kas` — og-image-broken
- `/pl/track` — should-be-noindex
