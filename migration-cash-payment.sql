...
INSERT INTO settings (key, value) VALUES ('cash_payment_enabled', 'false')
ON CONFLICT (key) DO NOTHING;

-- 4. Online payment discount (e.g. set value to '3' for 3%)
INSERT INTO settings (key, value) VALUES ('online_payment_discount_percent', '0')
ON CONFLICT (key) DO NOTHING;

-- 5. Night tariff toggle
INSERT INTO settings (key, value) VALUES ('night_tariff_enabled', 'false')
ON CONFLICT (key) DO NOTHING;

-- 6. Night tariff start time (HH:MM format, default midnight)
INSERT INTO settings (key, value) VALUES ('night_tariff_start', '00:00')
ON CONFLICT (key) DO NOTHING;

-- 7. Night tariff end time (HH:MM format, default 07:00)
INSERT INTO settings (key, value) VALUES ('night_tariff_end', '07:00')
ON CONFLICT (key) DO NOTHING;

-- 8. Night tariff surcharge percent (e.g. '4' for +4%)
INSERT INTO settings (key, value) VALUES ('night_tariff_percent', '0')
ON CONFLICT (key) DO NOTHING;
