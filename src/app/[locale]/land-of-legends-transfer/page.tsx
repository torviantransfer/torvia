...
const content: Partial<Record<Locale, {
  ...
  ro: {
    title: "Transfer Land of Legends | Aeroportul Antalya - Land of Legends",
    metaDesc: "Transfer privat VIP de la Aeroportul Antalya la parcul tematic Land of Legends din Belek. ~30 min, 35 km. Preț fix, întâmpinare cu panou, urmărirea zborului gratuită. Rezervă online.",
    heading: "Aeroportul Antalya → Transfer Land of Legends",
    subheading: "Transfer privat VIP către cel mai popular parc tematic din Turcia. Preț fix, fără timp de așteptare.",
    desc: "Parcul tematic Land of Legends se află în Belek, la aproximativ 35 km est de Aeroportul Antalya. Cu transferul privat VIP TORVIAN ajungi la parc în circa 30 de minute, în tot confortul — fără taxiuri, fără așteptare, fără surprize.",
    distance: "35 km",
    duration: "~30 min",
    features: [
      "Transfer direct din ușă în ușă de la Aeroportul Antalya (AYT)",
      "Preț fix — fără aparat de taxare, fără tarife majorate",
      "Întâmpinare cu panou în holul de sosiri",
      "Urmărirea zborului gratuită — așteptăm dacă ai întârziere",
      "Mercedes Vito VIP cu aer condiționat și Wi-Fi gratuit",
      "Anulare gratuită cu până la 24 de ore înainte",
      "Asistență WhatsApp 24/7",
    ],
    faqQ1: "La ce distanță este Land of Legends de Aeroportul Antalya?",
    faqA1: "Parcul tematic Land of Legends din Belek se află la aproximativ 35 km de Aeroportul Antalya (AYT). Drumul durează în jur de 30 de minute cu un vehicul privat.",
    faqQ2: "Cât costă un transfer către Land of Legends?",
    faqA2: "Transferul nostru cu preț fix către Land of Legends pornește de la un tarif fix per vehicul, nu per persoană. Prețul exact este afișat la rezervare. Fără costuri ascunse.",
    faqQ3: "Pot rezerva un transfer retur de la Land of Legends la aeroport?",
    faqA3: "Da, oferim și transferuri retur. Poți selecta cursa de întoarcere la rezervare și beneficiezi de un preț redus pentru dus-întors.",
    faqQ4: "Șoferul așteaptă la intrarea în parc?",
    faqA4: "La preluările de la hotel și la cursele de retur, șoferul te așteaptă la ora stabilită, în punctul de întâlnire convenit. La sosirea pe aeroport îți urmărim zborul și te întâmpinăm în holul de sosiri.",
    bookCta: "Rezervă transferul",
    whyTitle: "De ce să rezervi cu TORVIAN?",
  },
};
  ...
  return applySeoPage({
    ...
    alternates: {
      ...
      languages: {
        ...
        ro: `https://torviantransfer.com/ro${path}`,
      },
    },
