...
const REGIONS: { slug: string; km: number; min: number; name: Record<Locale, string> }[] = [
  { slug: "kundu-lara", km: 15, min: 20, name: { tr: "Kundu - Lara", en: "Kundu - Lara", de: "Kundu - Lara", pl: "Kundu - Lara", ru: "Кунду - Лара", nl: "Kundu - Lara", ro: "Kundu - Lara", ar: "كوندو - لارا" } },
  { slug: "sehirici", km: 12, min: 20, name: { tr: "Antalya Şehiriçi", en: "Antalya City Center", de: "Antalya Zentrum", pl: "Centrum Antalyi", ru: "Центр Анталии", nl: "Antalya City Center", ro: "Antalya City Center", ar: "وسط مدينة أنطاليا" } },
  { slug: "kadriye", km: 30, min: 30, name: { tr: "Kadriye", en: "Kadriye", de: "Kadriye", pl: "Kadriye", ru: "Кадрие", nl: "Kadriye", ro: "Kadriye", ar: "كادريه" } },
  { slug: "belek", km: 35, min: 35, name: { tr: "Belek", en: "Belek", de: "Belek", pl: "Belek", ru: "Белек", nl: "Belek", ro: "Belek", ar: "بيليك" } },
  { slug: "bogazkent", km: 45, min: 40, name: { tr: "Boğazkent", en: "Bogazkent", de: "Bogazkent", pl: "Bogazkent", ru: "Богазкент", nl: "Bogazkent", ro: "Bogazkent", ar: "بوغازكنت" } },
  { slug: "evrenseki", km: 60, min: 50, name: { tr: "Evrenseki", en: "Evrenseki", de: "Evrenseki", pl: "Evrenseki", ru: "Эвренсеки", nl: "Evrenseki", ro: "Evrenseki", ar: "إيفرنسكي" } },
  { slug: "side", km: 70, min: 60, name: { tr: "Side", en: "Side", de: "Side", pl: "Side", ru: "Сиде", nl: "Side", ro: "Side", ar: "سيده" } },
  { slug: "kizilagac", km: 80, min: 70, name: { tr: "Kızılağaç", en: "Kizilagac", de: "Kızılağaç", pl: "Kizilagac", ru: "Кызылагач", nl: "Kizilagac", ro: "Kizilagac", ar: "كيزيلاغاتش" } },
  { slug: "okurcalar", km: 100, min: 80, name: { tr: "Okurcalar", en: "Okurcalar", de: "Okurcalar", pl: "Okurcalar", ru: "Окурджалар", nl: "Okurcalar", ro: "Okurcalar", ar: "أوكورجالار" } },
  { slug: "turkler", km: 110, min: 85, name: { tr: "Türkler", en: "Turkler", de: "Türkler", pl: "Turkler", ru: "Тюрклер", nl: "Turkler", ro: "Turkler", ar: "تُركلر" } },
  { slug: "alanya", km: 130, min: 120, name: { tr: "Alanya", en: "Alanya", de: "Alanya", pl: "Alanya", ru: "Аланья", nl: "Alanya", ro: "Alanya", ar: "ألانيا" } },
  { slug: "mahmutlar", km: 140, min: 130, name: { tr: "Mahmutlar", en: "Mahmutlar", de: "Mahmutlar", pl: "Mahmutlar", ru: "Махмутлар", nl: "Mahmutlar", ro: "Mahmutlar", ar: "محمودلار" } },
  { slug: "kargicak", km: 145, min: 135, name: { tr: "Kargıcak", en: "Kargicak", de: "Kargıcak", pl: "Kargicak", ru: "Каргыджак", nl: "Kargicak", ro: "Kargicak", ar: "كارجيجاك" } },
  { slug: "beldibi", km: 40, min: 35, name: { tr: "Beldibi", en: "Beldibi", de: "Beldibi", pl: "Beldibi", ru: "Бельдиби", nl: "Beldibi", ro: "Beldibi", ar: "بلديبي" } },
  { slug: "goynuk", km: 50, min: 40, name: { tr: "Göynük", en: "Goynuk", de: "Göynük", pl: "Goynuk", ru: "Гёйнюк", nl: "Goynuk", ro: "Goynuk", ar: "غويْنوك" } },
  { slug: "kemer", km: 55, min: 50, name: { tr: "Kemer", en: "Kemer", de: "Kemer", pl: "Kemer", ru: "Кемер", nl: "Kemer", ro: "Kemer", ar: "كيمر" } },
  { slug: "kiris", km: 60, min: 55, name: { tr: "Kiriş", en: "Kiris", de: "Kiriş", pl: "Kiris", ru: "Кириш", nl: "Kiris", ro: "Kiris", ar: "كيريش" } },
  { slug: "camyuva", km: 65, min: 55, name: { tr: "Çamyuva", en: "Camyuva", de: "Çamyuva", pl: "Camyuva", ru: "Чамьюва", nl: "Camyuva", ro: "Camyuva", ar: "تشامْيوفا" } },
  { slug: "tekirova", km: 70, min: 60, name: { tr: "Tekirova", en: "Tekirova", de: "Tekirova", pl: "Tekirova", ru: "Текирова", nl: "Tekirova", ro: "Tekirova", ar: "تكيروفا" } },
  { slug: "adrasan", km: 95, min: 90, name: { tr: "Adrasan", en: "Adrasan", de: "Adrasan", pl: "Adrasan", ru: "Адрасан", nl: "Adrasan", ro: "Adrasan", ar: "أدراسان" } },
  { slug: "kas", km: 190, min: 180, name: { tr: "Kaş", en: "Kas", de: "Kaş", pl: "Kas", ru: "Каш", nl: "Kas", ro: "Kas", ar: "كاش" } },
  { slug: "kalkan", km: 210, min: 190, name: { tr: "Kalkan", en: "Kalkan", de: "Kalkan", pl: "Kalkan", ru: "Калкан", nl: "Kalkan", ro: "Kalkan", ar: "كالكان" } },
  { slug: "fethiye", km: 220, min: 200, name: { tr: "Fethiye", en: "Fethiye", de: "Fethiye", pl: "Fethiye", ru: "Фетхие", nl: "Fethiye", ro: "Fethiye", ar: "فتحية" } },
  { slug: "marmaris", km: 300, min: 270, name: { tr: "Marmaris", en: "Marmaris", de: "Marmaris", pl: "Marmaris", ru: "Мармарис", nl: "Marmaris", ro: "Marmaris", ar: "مرمريس" } },
];
