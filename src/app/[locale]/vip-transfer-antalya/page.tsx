...
const content: Partial<Record<Locale, {
  ...
  ro: {
    title: "Transfer VIP Aeroportul Antalya | Vehicul privat premium",
    metaDesc: "Transfer VIP de la Aeroportul Antalya: cel mai nou Mercedes Vito din flotă, șofer doar pentru tine, întâmpinare prioritară. Preț fix, fără opriri comune. Rezervă online în 2 minute.",
    heading: "Transfer VIP Aeroportul Antalya",
    subheading: "Nivelul premium al flotei TORVIAN — vehicule mai noi, un șofer numai pentru tine și o întâmpinare care începe din clipa în care ieși în holul de sosiri.",
    desc: "„Transfer VIP” înseamnă mai mult decât un vehicul privat: este cel mai bun vehicul din flota noastră, un șofer alocat exclusiv ție din momentul aterizării și o preluare care începe imediat ce ieși în holul de sosiri — nu zece minute mai târziu, în timp ce o navetă comună se umple. Prețul este același ca la transferul nostru privat standard; diferența stă în întregime în experiență.",
    features: [
      "Cel mai nou Mercedes Vito din flotă — tapițerie din piele, fără interior uzat",
      "Șofer numai pentru tine — niciodată împărțit cu altă rezervare",
      "Șofer vorbitor de engleză ca standard; germană sau rusă la cerere",
      "Întâmpinare prioritară: panoul cu numele tău este în față, în holul de sosiri",
      "Apă și cablu de încărcare pentru telefon la bord",
      "Wi-Fi gratuit și aer condiționat, pornit înainte de sosirea ta",
      "Același preț fix ca transferul standard — VIP este un nivel de serviciu, nu un supliment",
      "Acoperă orice zonă de stațiune de pe coastă, de la Kundu-Lara până la Alanya",
    ],
    vehicleTitle: "Vehiculul tău VIP",
    vehicleSpecs: [
      { label: "Până la 5 pasageri, un singur grup per vehicul", icon: "users" },
      { label: "Wi-Fi gratuit la bord", icon: "wifi" },
      { label: "Aer condiționat, pornit înainte de sosire", icon: "wind" },
      { label: "Cele mai noi vehicule din flotă", icon: "star" },
    ],
    regionsTitle: "Transfer VIP disponibil către",
    regions: [
      { label: "Transfer VIP către Belek", href: "/belek-transfer" },
      { label: "Transfer VIP către Side", href: "/side-transfer" },
      { label: "Transfer VIP către Alanya", href: "/alanya-transfer" },
      { label: "Transfer VIP către Kemer", href: "/kemer-transfer" },
      { label: "Transfer VIP către Kundu-Lara", href: "/kundu-lara-transfer" },
      { label: "Transfer VIP către centrul Antalyei", href: "/sehirici-transfer" },
    ],
    faqQ1: "Ce face acest transfer cu adevărat „VIP”?",
    faqA1: "Trei lucruri: vehiculul este cel mai nou Mercedes Vito din flota noastră, șoferul îți este alocat exclusiv din momentul aterizării până la destinație (fără opriri comune), iar întâmpinarea ta are prioritate, în față în holul de sosiri, nu într-o zonă generală de așteptare.",
    faqQ2: "Un transfer VIP costă mai mult decât un transfer privat standard?",
    faqA2: "Nu. La TORVIAN, VIP este nivelul nostru standard de serviciu, nu un upgrade plătit — fiecare rezervare include deja vehiculul privat, întâmpinarea și urmărirea zborului descrise aici, la același preț fix pe care îl vezi la finalizarea comenzii.",
    faqQ3: "Pot cere un șofer vorbitor de engleză sau germană?",
    faqA3: "Da. Toți șoferii vorbesc engleză de bază. Dacă vrei anume un șofer vorbitor de germană sau rusă, menționează la rezervare — confirmăm disponibilitatea înainte de ora preluării.",
    faqQ4: "Ce vehicul se folosește pentru serviciul VIP?",
    faqA4: "Un Mercedes Vito cu scaune din piele, aer condiționat și Wi-Fi gratuit, cu loc pentru până la 5 pasageri și spațiu generos pentru bagaje. Este același model în toată flota noastră — rezervările VIP primesc cel mai nou vehicul disponibil la data călătoriei tale.",
    faqQ5: "Transferul VIP acoperă orice zonă de stațiune sau doar anumite hoteluri?",
    faqA5: "Orice zonă de stațiune de pe Riviera Turcească pe care o deservim — de la Kundu-Lara, cea mai apropiată de aeroport, până la Alanya, la capătul estic al coastei. Alege destinația la rezervare; același standard VIP se aplică indiferent de distanță.",
    bookCta: "Rezervă transferul VIP",
    whyTitle: "Ce primești la fiecare rezervare VIP",
    breadcrumb: "Transfer VIP Antalya",
    standardNote: "VIP este standardul la TORVIAN — inclus în fiecare rezervare, fără supliment. Nu există un nivel „economy” separat de la care să încercăm să te urcăm.",
  },
};
