...
const content: Partial<Record<Locale, {
  ...
  ro: {
    title: "Transfer hotel Aeroportul Antalya | Direct la orice hotel, în orice regiune",
    metaDesc: "Transfer de la Aeroportul Antalya la orice hotel de pe coastă — nu trebuie să știi zona exactă a stațiunii ca să rezervi. Preț fix, șoferul cunoaște adresa. Rezervă online.",
    heading: "Transfer hotel Aeroportul Antalya",
    subheading: "O singură rezervare, orice hotel de pe Riviera Turcească — tu trebuie să știi doar numele hotelului, de rută ne ocupăm noi.",
    desc: "Majoritatea site-urilor de transfer îți cer să alegi mai întâi o zonă de stațiune înainte să îți dea un preț. Noi nu. Scrie numele hotelului la rezervare și trimitem șoferul direct acolo — fie că este un resort de cinci stele din Belek, fie un mic hotel boutique de pe o stradă despre care aplicația ta de hărți nu a auzit niciodată. Șoferul are adresa exactă înainte ca tu să aterizezi.",
    features: [
      "Funcționează pentru orice hotel cu nume, nu doar pentru marile lanțuri de resorturi",
      "Șoferul are adresa exactă a hotelului tău înainte ca avionul să aterizeze",
      "Nu trebuie să știi „zona de stațiune” — doar numele hotelului",
      "Preț fix la rezervare, calculat pe distanța reală până la hotelul tău",
      "Check-in târziu? Șoferul așteaptă — fără costuri suplimentare pentru sosirile de noapte",
      "Un transfer per rezervare de hotel, inclusiv pentru grupuri care sosesc cu zboruri diferite",
      "Cursa de retur de la același hotel se rezervă odată cu prima",
      "Acoperă orice hotel de la Kundu-Lara până la Alanya, din ușă în ușă",
    ],
    hotelsTitle: "Câteva hoteluri către care mergem în fiecare săptămână",
    hotels: [
      "Titanic Deluxe Lara",
      "Rixos Premium Belek",
      "Maxx Royal Belek",
    ...
    regionsTitle: "Sau caută după zona de stațiune",
    regions: [
      { label: "Hoteluri în Belek", href: "/belek-transfer" },
      { label: "Hoteluri în Side", href: "/side-transfer" },
      { label: "Hoteluri în Alanya", href: "/alanya-transfer" },
      { label: "Hoteluri în Kemer", href: "/kemer-transfer" },
      { label: "Hoteluri în Kundu-Lara", href: "/kundu-lara-transfer" },
      { label: "Hoteluri în centrul Antalyei", href: "/sehirici-transfer" },
    ],
    faqQ1: "Mergeți și la hotelul meu dacă nu este un lanț mare de resorturi?",
    faqA1: "Da. Scrie numele și adresa hotelului la rezervare, iar șoferul este îndrumat direct acolo — nu suntem limitați la o listă fixă de hoteluri partenere. Hotelurile boutique mici și apartamentele sunt la fel de ușor de găsit ca resorturile de cinci stele.",
    faqQ2: "Ce fac dacă nu știu în ce zonă de stațiune se află hotelul meu?",
    faqA2: "Nu trebuie să știi. Scrie numele hotelului în formularul de rezervare — sistemul îi găsește singur locația, nu trebuie să decizi tu dacă este Belek, Side sau altă zonă.",
    faqQ3: "Cum găsește șoferul hotelul meu noaptea?",
    faqA3: "Fiecare șofer primește coordonatele GPS ale hotelului înainte de preluare, nu doar numele. Sosirile de noapte costă la fel ca cele de zi — nu există taxă de noapte.",
    faqQ4: "Prețul diferă în funcție de hotelul ales?",
    faqA4: "Da, sincer — prețul se calculează pe distanța reală de condus până la hotelul tău și îți este arătat înainte de confirmare, niciodată ca o estimare fixă. Două hoteluri din același oraș pot avea prețuri ușor diferite dacă unul este mai departe de drumul principal.",
    faqQ5: "Pot rezerva un transfer pentru un grup care sosește cu zboruri diferite?",
    faqA5: "Da. Adaugă ora de sosire a fiecărui zbor în observațiile rezervării, iar noi programăm preluări separate către același hotel sau le combinăm într-un singur vehicul, dacă orele permit.",
    bookCta: "Rezervă transferul la hotel",
    whyTitle: "De ce este altfel decât un transfer obișnuit de aeroport",
    breadcrumb: "Transfer hotel Antalya",
    nightNote: "Ajungi după miezul nopții? Șoferul este deja programat — fără costuri suplimentare și fără să fie nevoie să suni dinainte.",
  },
};
