...
export async function generateMetadata({
  ...
  const seoRow = await getSeoPage("terms");
        ...
        <section className="py-16" style={{ backgroundColor: "#FFFFFF" }}>
          <div className="max-w-3xl mx-auto px-4">
            <div className="space-y-8 text-sm leading-relaxed text-gray-600">
              ...
              <div className="flex items-center gap-3 mt-10 mb-3">
                <div className="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold text-white" style={{ backgroundColor: "#007AFF" }}>9</div>
                <h2 className="text-lg font-bold text-gray-900">{t("s9Title")}</h2>
              </div>
              <p>
                {t("s9Text")}{" "}
