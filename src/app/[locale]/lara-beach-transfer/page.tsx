...
const content: Partial<Record<Locale, {
  ...
  ro: {
    title: "Transfer Aeroportul Antalya - Lara Beach | Privat VIP | ~20 min",
    metaDesc: "Transfer privat VIP de la Aeroportul Antalya la Lara Beach (Kundu). ~20 min, 15 km. Preț fix, întâmpinare cu panou, urmărirea zborului gratuită. Mai bun decât un taxi — rezervă online în 2 minute.",
    heading: "Aeroportul Antalya → Transfer Lara Beach",
    subheading: "Transfer privat VIP către hotelurile din Lara Beach — Aska Lara, Titanic Lara, Royal Seginus. Preț fix, fără taxiuri, fără așteptare.",
    desc: "Lara Beach (Kundu) este una dintre cele mai populare zone de stațiune din Antalya, cu câteva dintre cele mai bune hoteluri de 5 stele din Turcia. La doar 15 km est de Aeroportul Antalya (AYT), este cea mai apropiată destinație majoră — circa 20 de minute cu un transfer privat. Sari peste coada de la taxi și ajungi confortabil.",
    distance: "15 km",
    duration: "~20 min",
    hotels: "Aska Lara Resort & Spa, Titanic Deluxe Lara, Royal Seginus, Rixos Downtown Antalya",
    taxiNote: "De ce transfer privat în loc de taxi? Preț fix stabilit dinainte, șofer profesionist cu panou de întâmpinare, așteptare gratuită dacă zborul întârzie — fără surprize.",
    features: [
      "Transfer direct din ușă în ușă de la Aeroportul Antalya (AYT) la Lara Beach",
      "Preț fix — fără aparat de taxare, fără tarife majorate, fără negociere",
      "Întâmpinare cu panou în holul de sosiri",
      "Urmărirea zborului gratuită — așteptăm dacă ai întârziere",
      "Mercedes Vito VIP cu aer condiționat, Wi-Fi și scaune pentru copii la cerere",
      "Anulare gratuită cu până la 24 de ore înainte de plecare",
      "Asistență WhatsApp 24/7",
      "Toate hotelurile din Lara Beach: Aska Lara, Titanic, Royal Seginus și altele",
    ],
    faqQ1: "La ce distanță este Lara Beach de Aeroportul Antalya?",
    faqA1: "Lara Beach (zona Kundu) se află la aproximativ 15 km de Aeroportul Antalya (AYT). Un transfer privat durează în jur de 20 de minute — este cea mai apropiată zonă de stațiune majoră de aeroport.",
    faqQ2: "Un transfer privat este mai ieftin decât un taxi de la Aeroportul Antalya la Lara Beach?",
    faqA2: "Transferurile private TORVIAN au un preț fix, stabilit dinainte — spre deosebire de taxiurile cu aparat de taxare. Fără costuri ascunse, fără tarife majorate, iar șoferul te așteaptă gratuit dacă zborul întârzie.",
    faqQ3: "Către ce hoteluri din Lara Beach faceți transfer?",
    faqA3: "Deservim toate hotelurile din Lara Beach și Kundu, printre care Aska Lara Resort & Spa, Titanic Deluxe Lara Beach Hotel, Royal Seginus Hotel, Rixos Downtown Antalya, Mardan Palace și toate celelalte. Este suficient să scrii numele hotelului la rezervare.",
    faqQ4: "Pot rezerva un transfer retur de la Lara Beach la Aeroportul Antalya?",
    faqA4: "Da. Oferim atât curse dus, cât și dus-întors. Rezervă cursa de retur de la Lara Beach la Aeroportul Antalya în aceeași rezervare și primești un preț redus.",
    faqQ5: "Cum îmi găsesc șoferul în Aeroportul Antalya?",
    faqA5: "Șoferul te așteaptă în holul de sosiri cu un panou pe care este scris numele tău. Îți urmărim zborul în timp real — dacă are întârziere, șoferul este tot acolo, fără costuri suplimentare.",
    bookCta: "Rezervă transfer Lara Beach",
    whyTitle: "De ce TORVIAN pentru Lara Beach?",
    breadcrumb: "Transfer Lara Beach",
  },
};
