...
export default function HomeFAQ() {
  ...
  // Built from translations so the visible copy AND the FAQPage schema are in
  // the page's own language. Previously this was a hard-coded English array,
  // which meant a Turkish/German/Russian/Polish visitor saw English questions
  // and Google indexed an English FAQ schema on a non-English URL (language
  // mismatch → lost rich-result eligibility). The q1..q6 / a1..a6 keys already
  // exist in all six locale files.
  const faqs = [
    { q: t("q1"), a: t("a1") },
    { q: t("q2"), a: t("a2") },
    { q: t("q3"), a: t("a3") },
