...
const labels: Record<string, Record<string, string>> = {
  ...
  pl: {
    ...
    imp2: "Kierowca będzie czekał w wyznaczonym punkcie spotkania na lotnisku.",
  ...
  nl: {
    ...
    oneWay: "Enkele reis",
    roundTrip: "Retour",
    pickup: "Ophaaldatum & -tijd",
    returnLabel: "Retourdatum & -tijd",
    flight: "Vluchtnummer",
    hotel: "Hotel",
    vehicle: "Voertuig",
    ...
    qrLabel: "Toon deze QR aan uw chauffeur",
  ...
  ro: {
    ...
    returnLabel: "Data și ora returului",
    flight: "Număr zbor",
    hotel: "Hotel",
    vehicle: "Vehicul",
    passengers: "Pasageri",
    ...
    total: "TOTAL PLĂTIT",
    qrLabel: "Arătați acest cod QR șoferului",
    important: "INFORMAȚII IMPORTANTE",
    ...
    imp3: "Așteptare gratuită: 60 min pentru zboruri, 15 min pentru hoteluri.",
