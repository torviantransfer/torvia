...
const i18n: Record<string, Record<string, string>> = {
  ...
  de: {
    ...
    confirmedCash: "Ihre Anzahlung wurde erhalten. Ihr Transfer ist bestätigt.",
    depositPaid: "Gezahlte Anzahlung",
    depositLine: "An den Fahrer zahlen (Bargeld)",
  ...
  pl: {
    ...
    confirmedCash: "Twoja zaliczka została otrzymana. Transfer potwierdzony.",
    depositPaid: "Zapłacona zaliczka",
    depositLine: "Zapłać kierowcy (gotówka)",
  ...
  ru: {
    ...
    confirmedCash: "Ваш депозит получен. Трансфер подтверждён.",
    depositPaid: "Оплаченный депозит",
    depositLine: "Оплатить водителю (наличные)",
  ...
  nl: {
    subject: "Uw TORVIAN Transfer voucher",
    greeting: "Hallo",
    confirmed: "Uw VIP-transfer is bevestigd en betaald.",
    confirmedCash: "Uw aanbetaling is ontvangen. Uw transfer is bevestigd.",
    depositPaid: "Aanbetaling voldaan",
    depositLine: "Te betalen aan chauffeur (contant)",
    totalCash: "Totaal (Betalen in het voertuig)",
    showVoucher: "Toon deze voucher (geprint of op uw scherm) aan uw chauffeur bij het ophalen.",
    ...
    base: "Basisprijs",
    nightCharge: "Toeslag",
    childSeatFee: "Kinderzitje",
    rtDiscount: "Retourkorting",
    couponDiscount: "Kortingscode",
    total: "Totaal betaald",
    qrTitle: "Uw QR-voucher",
    qrInfo: "Toon deze QR-code aan uw chauffeur voor directe verificatie.",
    importantTitle: "Belangrijke informatie",
    imp1: "Uw chauffeur volgt uw vlucht — maakt u zich geen zorgen over vertraging.",
    imp2: "Uw chauffeur ontvangt u op het aangewezen ontmoetingspunt op de luchthaven.",
    imp3: "Gratis wachttijd: 60 min bij vluchten, 15 min bij hotels.",
    imp4: "Kinderzitje en stoelverhoger beschikbaar voor $10 per boeking.",
    imp5: "Neem voor toekomstige boekingen geen rechtstreeks contact op met de chauffeur. Ons bedrijf is niet aansprakelijk voor eventuele problemen.",
    contact: "Hulp nodig? Wij zijn 24/7 bereikbaar",
    footer: "Deze e-mail geldt als uw officiële transfervoucher.",
    driverAssignmentSubjectOutbound: "Uw chauffeur voor de heenreis is toegewezen",
    driverAssignmentSubjectReturn: "Uw chauffeur voor de terugreis is toegewezen",
    driverAssignmentBanner: "Uw chauffeur is toegewezen",
    driverAssignmentBody: "Uw transfer is aan een chauffeur toegewezen. Hieronder vindt u de details.",
    driverAssignmentDriverInfoTitle: "Chauffeursgegevens",
    driverAssignmentDriverLabel: "Chauffeur",
    driverAssignmentPhoneLabel: "Telefoon",
    driverAssignmentVehicleLabel: "Voertuig",
    driverAssignmentTransferDetailsTitle: "Transferdetails",
    driverAssignmentDateLabel: "Datum",
    driverAssignmentPickupTimeLabel: "Ophaaltijd",
    driverAssignmentImportantLabel: "Belangrijke mededeling",
    driverAssignmentEarlyWarningTitle: "Wees ten minste 2 uur voor het ophalen gereed.",
    driverAssignmentEarlyWarningBody: "Uw chauffeur arriveert op het afgesproken tijdstip bij uw hotel of adres.",
    driverAssignmentFooter: "Deze e-mail bevat uitsluitend transferinformatie.",
    airport: "Luchthaven Antalya",
  },
  ro: {
    subject: "Voucherul dumneavoastră TORVIAN Transfer",
    greeting: "Bună ziua",
    confirmed: "Transferul dumneavoastră VIP a fost confirmat și plătit.",
    confirmedCash: "Avansul dumneavoastră a fost primit. Transferul este confirmat.",
    depositPaid: "Avans achitat",
    depositLine: "De plătit șoferului (numerar)",
    totalCash: "Total (Plata în vehicul)",
    showVoucher: "Vă rugăm să prezentați acest voucher (tipărit sau pe ecran) șoferului la preluare.",
    code: "Cod rezervare",
    route: "Traseu",
    type: "Tip cursă",
    oneWay: "Dus",
    ...
    pieces: "buc",
    extras: "Extra",
    childSeatLabel: "Scaun pentru copii",
    priceSummary: "Sumar preț",
    base: "Preț de bază",
    nightCharge: "Taxă suplimentară",
    childSeatFee: "Scaun pentru copii",
    rtDiscount: "Reducere dus-întors",
    couponDiscount: "Reducere cupon",
    total: "Total plătit",
    qrTitle: "Voucherul dumneavoastră QR",
    qrInfo: "Arătați acest cod QR șoferului pentru verificare instantanee.",
    importantTitle: "Informații importante",
    imp1: "Șoferul urmărește zborul dumneavoastră — nu vă faceți griji pentru întârzieri.",
    imp2: "Șoferul vă va aștepta la punctul de întâlnire desemnat din aeroport.",
    imp3: "Timp de așteptare gratuit: 60 min pentru zboruri, 15 min pentru hoteluri.",
    imp4: "Scaun pentru copii și înălțător disponibile la $10 per rezervare.",
    imp5: "Nu contactați șoferul direct pentru rezervări viitoare. Compania noastră nu este responsabilă pentru eventualele probleme.",
    contact: "Aveți nevoie de ajutor? Suntem disponibili 24/7",
    footer: "Acest e-mail constituie voucherul dumneavoastră oficial de transfer.",
    driverAssignmentSubjectOutbound: "Șoferul pentru cursa dus a fost alocat",
    driverAssignmentSubjectReturn: "Șoferul pentru cursa retur a fost alocat",
    driverAssignmentBanner: "Șoferul dumneavoastră a fost alocat",
    driverAssignmentBody: "Transferul dumneavoastră a fost alocat unui șofer. Detaliile sunt mai jos.",
    driverAssignmentDriverInfoTitle: "Informații șofer",
    driverAssignmentDriverLabel: "Șofer",
    driverAssignmentPhoneLabel: "Telefon",
    driverAssignmentVehicleLabel: "Vehicul",
    driverAssignmentTransferDetailsTitle: "Detalii transfer",
    driverAssignmentDateLabel: "Data",
    driverAssignmentPickupTimeLabel: "Ora preluării",
    driverAssignmentImportantLabel: "Notificare importantă",
    driverAssignmentEarlyWarningTitle: "Vă rugăm să fiți pregătiți cu cel puțin 2 ore înainte de preluare.",
    driverAssignmentEarlyWarningBody: "Șoferul va sosi la ora programată la hotelul sau adresa dumneavoastră.",
...
export function buildVoucherHTML(data: ReservationEmailData, qrDataUrl: string): string {
  ...
  const wa = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "902426060763";
